...
> **Superseded/extended by v2 — see [`v2-paradigm.md`](v2-paradigm.md).** This doc describes the v1-era two-layer architecture; v2 keeps the fractal but adds 2 experts (Maya + Julius → 20 total), expands the mechanical-gate set to 58 mechanical gates — 54 registry-swept (G1–G37, G39–G43, G45–G55, G60) + 4 delivery-only (G56–G58, G61) invoked in the delivery gate runner; G38/G44/G59 reserved — and grows the integrator pool to 29 modules.
...
|---|---|---|---|
| **L1** | 机械门 硬规则 (58 mechanical gates — 54 registry-swept G1–G37, G39–G43, G45–G55, G60 + 4 delivery-only G56–G58, G61 invoked in the delivery gate runner;G38/G44/G59 reserved,§7) | ✓ | `src/opl_cancer/validators/gates/g<N>_*.py` |
...
- [`mechanical-gates.md`](mechanical-gates.md) — L1 58 mechanical gates — 54 registry-swept (G1–G37, G39–G43, G45–G55, G60) + 4 delivery-only (G56–G58, G61) invoked in the delivery gate runner;G38/G44/G59 reserved — × failure mode
