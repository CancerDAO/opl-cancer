...
EXPECTED_GATE_COUNT = 49  # v2.8: G1-G37 + G39-G43 + G45/G46/G47/G48/G49/G52 + G54 (G38, G44 reserved)
...
EXPECTED_GATE_NUMBERS = set(range(1, 38)) | {39, 40, 41, 42, 43, 45, 46, 47, 48, 49, 52, 54}  # 37 + 12 = 49
