# OPL-for-Cancer bixbench Dockerfile (P3-T9)
# Source: lifted from robin/finch/src/fhda/Dockerfile.pinned
# Tag (local build target): opl-cancer/bixbench:v0.3.0-p3
# Entrypoint contract: jupyter execute /workspace/<notebook>.ipynb
# Workdir: /workspace (mount patient analysis dir here read-write)
# NB: this image is NOT built in CI — see compute/runner.py env-gate OPL_BIXBENCH_LIVE.
#
